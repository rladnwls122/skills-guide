...
| [6](PART-6-Task3-Operations/)       | 14    | D15~16 | 3과제 부하 운영 — SLO·비용 ratio·부하 중 복구                | 부하 드릴 4축 중 3개 통과 |

하루 8-10h 기준: 이론 2h + 실습 6-7h + 회고·정리 1h(고정).

## 모듈 사용법 (매 모듈 동일 순서)

1. `README.md` — 목표·소요 시간·비용 + **선행 지식** 블록 확인 (막히는 항목만 00 문서로)
...
- [ ] PART 6 3과제 부하 드릴 (p90 __ms / 실패율 __% / 노드 __대)
