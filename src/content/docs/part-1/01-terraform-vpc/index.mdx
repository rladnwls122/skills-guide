...
- 서브넷이 퍼블릭인지 결정하는 것은 이름이 아니라 **연결된 RTB** — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
- 프라이빗 인스턴스의 아웃바운드 경로: 프라이빗 RTB → NAT GW → 퍼블릭 RTB → IGW — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
- SG는 스테이트풀, NACL은 스테이트리스 — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
- `--query`(JMESPath)와 `jq`로 출력에서 값만 뽑는 법 — [awscli-basics](/skills-2026-learn_module/start/awscli-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-1/01-terraform-vpc/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-1/01-terraform-vpc/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
