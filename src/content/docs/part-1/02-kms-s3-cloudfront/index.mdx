...
- 정책 JSON 4요소(Effect/Action/Resource/Condition)와 **명시적 Deny 우선** — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- 권한 정책 vs 신뢰 정책의 차이 — KMS 키 정책은 리소스에 붙는 권한 정책이다 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- root를 Principal에서 빼는 이유 — root로 만든 리소스는 이후 키 사용이 막힌다 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- `aws ... --query`로 배포·버킷 속성만 뽑아 확인하는 법 — [awscli-basics](/skills-2026-learn_module/start/awscli-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-1/02-kms-s3-cloudfront/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-1/02-kms-s3-cloudfront/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
