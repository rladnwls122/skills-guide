...
- push 3단계: build → tag(레지스트리 주소 포함) → push — [docker-basics](/skills-2026-learn_module/start/docker-basics/)
- `RUN`은 빌드 시점, `ENTRYPOINT`/`CMD`는 실행 시점 — [docker-basics](/skills-2026-learn_module/start/docker-basics/)
- 베이스 이미지 크기가 pull 지연과 스캔 결과를 좌우한다 — [docker-basics](/skills-2026-learn_module/start/docker-basics/)
- 역할(Role) = 자격증명 없는 신원. Lambda 실행역할이 이것 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-1/03-container-lambda-dynamodb/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-1/03-container-lambda-dynamodb/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
