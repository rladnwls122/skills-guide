...
- 컨트롤 플레인(EKS가 관리) ↔ 노드(EC2) 분담. `kubectl`은 API server로 간다 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- ServiceAccount = 파드의 신원. IRSA·Pod Identity는 여기에 IAM 역할을 붙이는 방식 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- 신뢰 정책(문지기) + 호출자 권한, **둘 다** 통과해야 AssumeRole이 성립 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- 클러스터를 만든 신원만 기본 kubectl 접근을 갖는다 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- 노드는 프라이빗 서브넷에 있다. NAT 경로가 없으면 이미지 pull부터 실패 — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-2/04-eksctl-cluster/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-2/04-eksctl-cluster/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
