...
```mermaid
graph TD
    subgraph addonNG["<span class='icon--logos icon--logos--aws-ec2'></span> wskorea26-addon-ng<br/>(label node-type=addon)"]
    ...
    subgraph appNG["<span class='icon--logos icon--logos--aws-ec2'></span> wskorea26-app-ng<br/>(label node-type=app)"]
        book["book Pod x2"]
    end
