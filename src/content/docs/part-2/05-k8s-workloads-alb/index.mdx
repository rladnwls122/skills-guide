...
- Deployment → ReplicaSet → Pod 관계. 직접 만지는 것은 Deployment뿐 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- Service(ClusterIP)가 라벨 셀렉터로 파드에 분배한다. 대회는 LoadBalancer 타입을 쓰지 않는다 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- Helm의 repo/chart/release/values 개념 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- SG는 스테이트풀 — ALB→노드 인바운드만 열면 응답은 자동 허용 — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-2/05-k8s-workloads-alb/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-2/05-k8s-workloads-alb/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
