...
1과제는 경기 시작 직전 수상 후보 **set-02·set-03·set-07 중 하나**가 선정된다. 이 모듈과 런북은 set-02 기준이며, set-03·set-07이 선정되면 WAF·관측성 등 요구사항이 달라진다. 세 후보의 구성 차이는 [이론 4절](/part-2/06-full-deploy-set02/theory/)에서 표로 정리한다 — set-03·set-07은 특히 Prometheus·Grafana·Fluent Bit 관측성이 **이 모듈(1과제, 4시간) 안에** 들어 있어 [PART-3 모듈 07](/part-3/07-observability/)보다 먼저 필요해진다.
:::
