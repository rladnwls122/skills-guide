...
graph TD
    ...
    subgraph EKS["<span class='icon--logos icon--logos--aws-eks'></span> EKS wskorea26-cluster (priv-subnet-c/d)"]
        ...
        FB@{ icon: "mdi:script-text-outline", form: "square", label: "Fluent Bit DaemonSet(전 노드) → CloudWatch Logs", pos: "b", h: 46, w: 46 }
    end
...
graph LR
    ...
    S5 --> S6
    S7@{ icon: "mdi:script-text-outline", form: "square", label: "7 Fluent Bit", pos: "b", h: 46, w: 46 }
    S6 --> S7
