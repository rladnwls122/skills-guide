...
| 모듈 | 옮긴 것 |
|---|---|
| [01](/part-1/01-terraform-vpc/lab/) | CIDR 규칙 계산 · 3 AZ 6 서브넷 · VPC Endpoint · Flow Log |
| [02](/part-1/02-kms-s3-cloudfront/lab/) | 키 분류 축(리소스별 → 용도별) · 90일 회전 · 다중 리전 키 · 버킷 버전 관리 · WAF 신설 |
| [03](/part-1/03-container-lambda-dynamodb/lab/) | 파티션 키 · GSI 축 · PITR · 태그 정책 · 로그 그룹 지정 |
| [04](/part-2/04-eksctl-cluster/lab/) | IRSA → Pod Identity · private 클러스터 · 3 AZ · CMK 볼륨 · KST |
| [05](/part-2/05-k8s-workloads-alb/lab/) | 인터넷 ALB → internal ALB + VPC Origin · SA 직접 생성 |
| [06](/part-2/06-observability/lab/) | 수집 범위 · 로그 형식 · 저장소 · 네임스페이스 분리 |
