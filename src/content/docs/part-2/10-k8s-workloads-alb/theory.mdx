...
CIDR 표기와 AZ(가용 영역)는 [vpc-basics](/start/vpc-basics/), ARN(리소스의 전역 고유 이름)은 [iam-basics](/start/iam-basics/), IRSA(파드에 IAM 역할을 붙이는 방식)는 [eks-basics](/start/eks-basics/)에 있다.
