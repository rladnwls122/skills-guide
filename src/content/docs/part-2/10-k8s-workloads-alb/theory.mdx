...
ALB·타깃그룹·헬스체크가 무엇인지는 [loadbalancer-basics](/start/loadbalancer-basics/)에 있다. "Ingress 로 만들게 하는 길" 대신 "직접 만들고 등록만 맡기는 길"을 고르는 이유는 [그 문서의 길 B 절](/start/loadbalancer-basics/#5-3-길-b--내가-만들고-등록만-맡긴다-targetgroupbinding)이 두 방식을 나란히 놓고 설명한다.
