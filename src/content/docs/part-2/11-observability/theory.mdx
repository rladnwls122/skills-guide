...
한 Helm 차트가 여섯을 함께 설치한다 — Prometheus Operator·Prometheus·Alertmanager·node-exporter·kube-state-metrics·Grafana 다. CRD(`PrometheusRule`, `PodMonitor`, `ServiceMonitor`)로 룰/스크레이프 대상을 선언한다.
