---
title: 12. k8s 워크로드 + ALB 연동 — Deployment / Helm / TargetGroupBinding
...
<LinkButton href="/part-2/12-k8s-workloads-alb/theory/" icon="right-arrow">이론 읽기</LinkButton>
<LinkButton href="/part-2/12-k8s-workloads-alb/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
