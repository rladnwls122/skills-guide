---
title: 15. 이론 — set-02 전체 아키텍처와 CloudFront
...
선행 지식과 학습 경로는 [모듈 개요](/part-2/15-full-deploy-set02/)에.
...
|---|---|
| set-02 | 이 모듈 그대로 진행 |
| set-03 | [WAF](/part-1/07-kms-s3-cloudfront/theory/) 커스텀 매치 규칙 절 + 같은 모듈의 root-less KMS 심화 절 + [PART-2 모듈 13](/part-2/13-observability/theory/) 관측성 스택을 4시간 안에 압축할 순서 |
...
| [09](/part-1/09-container-lambda-dynamodb/lab/) | 파티션 키 · GSI 축 · PITR · 태그 정책 · 로그 그룹 지정 |
| [11](/part-2/11-eksctl-cluster/lab/) | IRSA → Pod Identity · private 클러스터 · 3 AZ · CMK 볼륨 · KST |
| [12](/part-2/12-k8s-workloads-alb/lab/) | 인터넷 ALB → internal ALB + VPC Origin · SA 직접 생성 |
| [13](/part-2/13-observability/lab/) | 수집 범위 · 로그 형식 · 저장소 · 네임스페이스 분리 |
