...
<LinkButton href="/part-3/07-observability/theory/" icon="open-book">이론 읽기</LinkButton>
<LinkButton href="/part-3/07-observability/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
