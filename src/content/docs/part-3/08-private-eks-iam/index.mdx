...
- AssumeRole은 신뢰 정책과 호출자 권한을 **양쪽 다** 평가한다 — audit role 드릴의 핵심 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- 역할·권한 정책·신뢰 정책의 구분, 명시적 Deny 우선 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- NAT 없는 프라이빗 서브넷에서 나가는 유일한 길은 VPC Endpoint — [vpc-basics](/skills-2026-learn_module/start/vpc-basics/)
- ServiceAccount = 파드의 신원 (Pod Identity가 깨지는 지점을 이해하는 전제) — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- 재접속마다 다시 도는 멱등 셋업 스크립트 작성 — [shell-basics](/skills-2026-learn_module/start/shell-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-3/08-private-eks-iam/theory/" icon="open-book">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-3/08-private-eks-iam/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
