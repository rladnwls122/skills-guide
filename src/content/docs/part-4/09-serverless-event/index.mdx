...
- 역할(Role)과 신뢰 정책 — Lambda·Step Functions·EventBridge가 각각 다른 역할을 Assume한다 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- 명시적 Deny 우선, Condition으로 범위를 좁히는 법 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
- `aws ... --query`로 실행 이력·항목을 확인하는 조회 명령 — [awscli-basics](/skills-2026-learn_module/start/awscli-basics/)
...
<LinkButton href="/skills-2026-learn_module/part-4/09-serverless-event/theory/" icon="open-book">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-4/09-serverless-event/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
