...
description: 2과제 유형 3(SQS→KEDA→Karpenter)·유형 4(OTel→Loki→Grafana)를 실습하고 유형 5(Kinesis/MSK)는 함정 암기로 대체하는 Day 11 모듈 개요.
---
...
- Deployment의 `replicas`를 바깥에서 조종하는 것이 오토스케일러(KEDA/HPA)다 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- 파드 `requests`가 스케줄링 단위 — 노드 수 계산의 입력값 — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- ConfigMap 주입과 라벨 셀렉터 (OTel Collector·Loki 설정에서 반복) — [k8s-basics](/skills-2026-learn_module/start/k8s-basics/)
- ServiceAccount에 붙는 IAM 역할이 SQS·S3 접근을 만든다 — [iam-basics](/skills-2026-learn_module/start/iam-basics/)
...
- skills-2026
  ...
  - set-02/task-2
    - module-2-analytics
      - **README.md** 유형 5 Flink Studio 함정 원문
    - module-4-msk
      - **README.md** 유형 5 MSK 함정 원문
...
<LinkButton href="/skills-2026-learn_module/part-4/10-scaling-logging-streaming/theory/" icon="open-book">이론 읽기</LinkButton>
<LinkButton href="/skills-2026-learn_module/part-4/10-scaling-logging-streaming/lab/" variant="minimal" icon="rocket">실습 시작</LinkButton>
