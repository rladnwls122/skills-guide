...
flowchart LR
    ...
    KEDA@{ icon: "logos:kubernetes", form: "square", label: "KEDA ScaledObject<br/>order-scaler<br/>min 1 / max 5 / queueLength 5", pos: "b", h: 46, w: 46 }
    DEP@{ icon: "logos:kubernetes", form: "square", label: "Deployment order-processor<br/>requests 500m/512Mi<br/>nodeSelector: skm-app-nodepool", pos: "b", h: 46, w: 46 }
    KARP@{ icon: "logos:kubernetes", form: "square", label: "Karpenter (kube-system)<br/>NodePool skm-app-nodepool<br/>taint dedicated=app", pos: "b", h: 46, w: 46 }
...
flowchart LR
    subgraph EKS["<span class='icon--logos icon--logos--aws-eks'></span> EKS o11y-cluster (노드 2대 Multi-AZ)"]
        APP@{ icon: "logos:kubernetes", form: "square", label: "log-generator ×2 (ns o11y)<br/>제공 app.py: /healthz /log<br/>+ 자체 Dockerfile", pos: "b", h: 46, w: 46 }
...
flowchart LR
    ...
    subgraph MSK["<span class='icon--logos icon--logos--aws-msk'></span> MSK (set-02 m4)"]
        ...
        LC@{ icon: "logos:aws-lambda", form: "square", label: "Lambda consumer ×2<br/>python3.14", pos: "b", h: 46, w: 46 }
