...
2과제 set-08 task-2 module-2(Simplify Service Networking with VPC Lattice, **도쿄 ap-northeast-1**)를 다룬다. `skills-2026` 저장소에 이 모듈의 참고 구현이 없어 이 문서와 [lab](/part-4/12-vpc-lattice/lab/)이 유일한 근거다.
