...
- [../../reference/mark-script-guide.md](/reference/mark-script-guide/) 숙지

## 파일

- [theory.md](/part-5/11-mutation-drill/theory/) — 판단 원칙과 변동 대응 방법론 + 퀴즈
- [lab.md](/part-5/11-mutation-drill/lab/) — 훈련 ①②③ 절차·판정 기준·회고 양식
