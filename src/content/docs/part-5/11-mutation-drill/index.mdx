---
title: 11. 변동 드릴 — 30% 변동 대응 (Day 12)
description: 대회 당일 30% 수정되는 과제지를 받고 30분 안에 코드베이스 전체에 반영하는 근육을 만드는 Day 12 모듈 개요.
---
...
- `grep -rn`으로 이름이 박힌 파일을 전부 찾고, `sed`로 일괄 치환하는 원라이너 — [shell-basics](/skills-2026-learn_module/start/shell-basics/)
- 치환 후 잔존 확인: 같은 패턴을 다시 grep해 0건인지 본다 — [shell-basics](/skills-2026-learn_module/start/shell-basics/)
- `aws ... --query`로 실제 생성된 리소스 이름을 뽑아 과제지와 대조 — [awscli-basics](/skills-2026-learn_module/start/awscli-basics/)
...
- [mark 스크립트 가이드](/skills-2026-learn_module/reference/mark-script-guide/) 숙지
...
<CardGrid>
  <Card title="theory" icon="open-book">
    ...
    [읽기](/skills-2026-learn_module/part-5/11-mutation-drill/theory/)
  </Card>
  <Card title="lab" icon="rocket">
    훈련 ①②③ 절차·판정 기준·회고 양식.

    [실습하기](/skills-2026-learn_module/part-5/11-mutation-drill/lab/)
  </Card>
</CardGrid>

<LinkButton href="/skills-2026-learn_module/part-5/11-mutation-drill/theory/" icon="right-arrow">이론부터 시작</LinkButton>
