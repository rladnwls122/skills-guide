---
title: 11. 변동 드릴 — 30% 변동 대응 (시간 여유 시)
description: 대회 당일 30% 수정되는 과제지를 받고 30분 안에 코드베이스 전체에 반영하는 근육을 만드는 모듈 개요. 정해진 일차 없음 — 시간이 남을 때 한다.
---
...
<CardGrid>
  <Card title="theory" icon="open-book">
    ...
    [읽기](/part-5/11-mutation-drill/theory/)
  </Card>
  <Card title="lab" icon="rocket">
    훈련 ①②③ 절차·판정 기준·회고 양식.

    [실습하기](/part-5/11-mutation-drill/lab/)
  </Card>
</CardGrid>

<LinkButton href="/part-5/11-mutation-drill/theory/" icon="right-arrow">이론부터 시작</LinkButton>
