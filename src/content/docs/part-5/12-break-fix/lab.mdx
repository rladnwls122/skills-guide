...
- [트러블슈팅](/skills-2026-learn_module/reference/troubleshooting/) 참조는 허용(대회장에도 가져갈 문서)하되 참조 여부를 회고 표에 기록 — 참조 없이 되는 개수를 늘려가는 게 목표.
...
- ⑪⑫는 대기가 길다 — 다른 시나리오와 병렬 진행 ([소요 시간표](/skills-2026-learn_module/reference/timings/)의 "긴 것 먼저").
