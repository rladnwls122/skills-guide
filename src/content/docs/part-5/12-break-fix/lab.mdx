...
- [../../reference/troubleshooting.md](/reference/troubleshooting/) 참조는 허용(대회장에도 가져갈 문서)하되 참조 여부를 회고 표에 기록 — 참조 없이 되는 개수를 늘려가는 게 목표. AI를 열었으면 실패 처리.
...
- ⑪⑫는 대기가 길다 — 다른 시나리오와 병렬 진행 ([../../reference/timings.md](/reference/timings/)의 "긴 것 먼저").
