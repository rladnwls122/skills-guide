...
- [../../reference/timings.md](/reference/timings/) · [../../reference/mark-script-guide.md](/reference/mark-script-guide/) 암기 수준

## 파일

- [theory.md](/part-5/13-mock-exam/theory/) — 시험 운영 전략(시간 배분·막힘 규칙) + 퀴즈
- [lab.md](/part-5/13-mock-exam/lab/) — 진행 절차·판정 기준·오답 노트 양식·종료 후 과제
...
전체 목록은 [../../reference/links.md](/reference/links/).
