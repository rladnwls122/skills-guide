...
착수 순서는 [소요 시간표](/skills-2026-learn_module/reference/timings/) — 긴 것 먼저.
...
- [ ] **T+3:20 목표** 구현 완료. [mark 스크립트 가이드](/skills-2026-learn_module/reference/mark-script-guide/)의 **채점 직전 리셋 체크리스트** 수행
...
- 작성 후 실패 항목을 [트러블슈팅](/skills-2026-learn_module/reference/troubleshooting/)에 자기 언어로 추가.
