...
착수 순서는 [../../reference/timings.md](/reference/timings/) — 긴 것 먼저.
...
- [ ] **T+3:20 목표** 구현 완료. [../../reference/mark-script-guide.md](/reference/mark-script-guide/)의 **채점 직전 리셋 체크리스트** 수행
...
- 작성 후 실패 항목을 [../../reference/troubleshooting.md](/reference/troubleshooting/)에 자기 언어로 추가.
