...
4시간에서 대기 시간을 작업 시간으로 바꾸는 게 전략의 전부다. [소요 시간표](/skills-2026-learn_module/reference/timings/)의 소요표 기준:
...
[mark 스크립트 가이드](/skills-2026-learn_module/reference/mark-script-guide/)의 **리셋 체크리스트**를 기계적으로 수행 — 시연 데이터 정리(재현 절차는 정확히 1회), 상태 복원, 트래픽 시드, 임시 리소스 제거, 채점 신원 확인.
:::
