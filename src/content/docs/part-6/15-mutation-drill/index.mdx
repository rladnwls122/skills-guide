---
title: 15. 변동 드릴 — 30% 변동 대응 (시간 여유 시)
description: 대회 당일 30% 수정되는 과제지를 받고 30분 안에 코드베이스 전체에 반영하는 훈련 모듈 개요. 정해진 일차 없음 — 시간이 남을 때 한다.
---
...
정해진 일차 없음 — 배점이 없는 훈련이라 시간이 남을 때 끼워 넣는다. 약 3~4시간 (훈련 ① 30분 x 2회 + 훈련 ② 1시간 + 훈련 ③ 1시간).
...
<CardGrid>
  <Card title="theory" icon="open-book">
    ...
    [읽기](/part-6/15-mutation-drill/theory/)
  </Card>
  <Card title="lab" icon="rocket">
    훈련 ①②③ 절차·판정 기준·회고 양식.

    [실습하기](/part-6/15-mutation-drill/lab/)
  </Card>
</CardGrid>

<LinkButton href="/part-6/15-mutation-drill/theory/" icon="right-arrow">이론부터 시작</LinkButton>
