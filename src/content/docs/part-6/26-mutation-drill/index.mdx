---
title: 26. 변동 드릴 — 30% 변동 대응 (시간 여유 시)
...
<CardGrid>
  <Card title="theory" icon="open-book">
    ...
    [읽기](/part-6/26-mutation-drill/theory/)
  </Card>
  <Card title="lab" icon="rocket">
    훈련 ①②③ 절차·판정 기준·회고 양식.

    [실습하기](/part-6/26-mutation-drill/lab/)
  </Card>
</CardGrid>

<LinkButton href="/part-6/26-mutation-drill/theory/" icon="right-arrow">이론부터 시작</LinkButton>
