...
2과제는 세트마다 **독립 모듈 4개**(각 7.5점)다. 후보가 set-02·07·08 셋이므로 사정권은 **12개 모듈** 전체다. 추첨된 1인의 세트 4개가 전부 출제되고, 협의회 공지대로 최대 2개가 더 붙어 최대 6개를 푼다 — 어느 세트가 뽑히든 그 세트의 1·2·3·4모듈을 다 풀어야 한다.
