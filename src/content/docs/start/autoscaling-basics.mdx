...
선수 학습은 여기서 끝난다 — [선수 지식 개요](/start/)의 완료 체크를 마친 뒤 PART 1 로 넘어간다. 이 문서의 내용은 모듈 10 에서 실습한다.

<LinkButton href="/part-1/01-terraform-vpc/" icon="right-arrow">PART 1 시작</LinkButton>
<LinkButton href="/part-4/10-scaling-logging-streaming/" variant="minimal">모듈 10 — 오토스케일링 + 로깅 + 스트리밍</LinkButton>
