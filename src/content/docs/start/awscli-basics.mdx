...
선수 학습 완료 — [선수 지식 개요](/skills-2026-learn_module/start/)의 완료 체크를 마친 뒤 PART 1로 넘어간다. 채점 역추적 훈련은 [PART 5 — Battle Drills](/skills-2026-learn_module/part-5/11-mutation-drill/)에서 이어진다.

<LinkButton href="/skills-2026-learn_module/part-1/01-terraform-vpc/" icon="right-arrow">PART 1 시작</LinkButton>
<LinkButton href="/skills-2026-learn_module/start/" variant="minimal">완료 체크로 돌아가기</LinkButton>
