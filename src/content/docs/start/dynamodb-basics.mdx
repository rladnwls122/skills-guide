...
PART-1 모듈 03 에서 이 테이블을 Terraform 으로 만들고 Lambda 로 조회한다. 그 전에 클러스터 쪽 기초가 하나 남았다.

<LinkButton href="/start/k8s-basics/" icon="right-arrow">다음 선수 학습 — Kubernetes 기초</LinkButton>
<LinkButton href="/part-1/03-container-lambda-dynamodb/" variant="minimal">PART 1 — ECR·Lambda·DynamoDB</LinkButton>
