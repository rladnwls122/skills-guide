...
- destroy 후 잔존 리소스 일괄 점검: [reference/cleanup-check.md](/reference/cleanup-check/)
...
모든 모듈이 이 저장소의 수상 과제 코드를 참조한다. 경로 매핑: [reference/links.md](/reference/links/)
...
| 가이드 | 자가진단 항목 | 대회 연결 |
|---|---|---|
| [vpc-basics.md](/start/vpc-basics/) | 1 | RTB↔서브넷 매핑 채점, PART-1 모듈 01 |
| [iam-basics.md](/start/iam-basics/) | 2, 3 | root-less KMS·채점 신원, PART-3 모듈 08 |
| [docker-basics.md](/start/docker-basics/) | 4 | CloudShell 빌드·ECR, PART-1 모듈 03 |
| [shell-basics.md](/start/shell-basics/) | 5 | 30% 변동 드릴, PART-5 모듈 11 |
| [awscli-basics.md](/start/awscli-basics/) | 3 | mark.sh 채점 역추적 |
| [k8s-basics.md](/start/k8s-basics/) | 7 (권장) | PART-2 모듈 05 k8s 워크로드 |
