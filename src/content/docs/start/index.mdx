...
- destroy 후 잔존 리소스 일괄 점검: [잔존 리소스 점검](/reference/cleanup-check/)
...
| 가이드 | 자가진단 항목 | 대회 연결 |
|---|---|---|
| [VPC 기초](/start/vpc-basics/) | 1 | RTB↔서브넷 매핑 채점, PART-1 모듈 01 |
| [IAM 기초](/start/iam-basics/) | 2, 3 | root-less KMS·채점 신원, PART-3 모듈 08 |
| [Docker 기초](/start/docker-basics/) | 4 | CloudShell 빌드·ECR, PART-1 모듈 03 |
| [셸 기초](/start/shell-basics/) | 5 | 30% 변동 드릴, PART-5 모듈 11 |
| [AWS CLI 기초](/start/awscli-basics/) | 3 | mark.sh 채점 역추적 |
| [Kubernetes 기초](/start/k8s-basics/) | 7 (권장) | PART-2 모듈 05 k8s 워크로드 |
