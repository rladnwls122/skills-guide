...
flowchart TB
    ...
    subgraph CLUSTER["<span class='icon--logos icon--logos--aws-eks'></span> EKS 클러스터"]
        subgraph NGADDON["<span class='icon--logos icon--logos--aws-ec2'></span> addon 노드그룹 (taint/label: node-type=addon)"]
            ...
            FB1@{ icon: "mdi:script-text-outline", form: "square", label: "DaemonSet: Fluent Bit", pos: "b", h: 46, w: 46 }
        end
        subgraph NGAPP["<span class='icon--logos icon--logos--aws-ec2'></span> app 노드그룹 (label: node-type=app)"]
            FB2@{ icon: "mdi:script-text-outline", form: "square", label: "DaemonSet: Fluent Bit", pos: "b", h: 46, w: 46 }
